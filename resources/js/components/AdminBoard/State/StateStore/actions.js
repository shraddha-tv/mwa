...
export const get_items = ({ commit }, page) => {
    return new Promise((resolve, reject) => {
        axios.get(`api/states?page=${page}`).then(response => {
...
export const add_new_item = ({ commit, dispatch }, item) => {
    return new Promise((resolve, reject) => {
        axios.post('api/states', item).then(response => {
...
export const update_item = ({ commit, dispatch }, item) => {
    return new Promise((resolve, reject) => {
        axios.put(`api/states/${item.id}`, item).then(response => {
...
export const delete_item = ({ dispatch }, id) => {
    return new Promise((resolve, reject) => {
        axios.delete(`api/states/${id}`).then(response => {
